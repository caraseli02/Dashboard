      ...
      <nav class="flex items-center justify-between md:justify-between w-full">
        ...
        <section class="flex justify-between items-center">
          <span v-for="link in links" :key="link.name">
            <router-link
              :to="link.to"
              class="ml-2 flex justify-center items-center p-2 rounded-lg text-primary bg-primary"
        ...
        <div class="flex justify-end items-center w-40">
          ...
          <button
            @click="closeSession"
            class="flex justify-center items-center p-3 rounded-lg text-primary bg-primary mr-2 logOut"
            v-if="user"
          >
            Salir
