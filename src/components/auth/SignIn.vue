          ...
          <div class="mt-6">
            <transition name="slide-fade">
              <form v-if="!showForgotPopUp" @submit.prevent>
                <div>
                  <label for="email" class="block text-sm font-medium leading-5 text-secondary">
                    Email address
                  </label>
                  <div class="mt-1 rounded-md shadow-sm">
                    <input type="email" placeholder="apimosa@apimosa.com" v-model="email" id="email" required
                ...
                <div class="mt-6">
                  <label for="password" class="block text-sm font-medium leading-5 text-secondary">
                    Password
                  </label>
                  <div class="mt-1 rounded-md shadow-sm">
                ...
                <div class="mt-6 flex flex-col items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <label for="remember_me" class="ml-2 block text-sm leading-5 text-secondary">
                      Remember me
                    </label>
                  </div>
                </div>
              ...
              <forgot-password v-on:closePopUp="showForgotPopUp = $event" v-if="showForgotPopUp" :theme="theme">
                <button
                  ...
                  type="button" aria-label="like" @click="showForgotPopUp = !showForgotPopUp">
                  Cerrar
                </button>
              </forgot-password>
            </transition>
            <div class="text-lg leading-5 my-4 text-center">
              <button
