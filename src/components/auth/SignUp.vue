          ...
          <div>
            <form @submit.prevent="validate">
              <div v-for="(field, index) in inputs" :key="index" class="mt-6">
                <label :for="field.id" class="block text-sm font-medium leading-5 text-secondary">
                  {{ field.id }}
                </label>
                <div class="mt-1 rounded-md shadow-sm">
                  <input :placeholder="field.placeholder" :type="field.type" v-model="field.model" :id="field.id"
              ...
              <div class="relative">
                <label class="block mb-2 uppercase tracking-wide text-secondary text-xs  mt-4" for="grid-state">
                  Centro de Trabajo
                </label>
                <select
                  ...
                  v-model="workplace" id="grid-state">
              ...
              <div class="flex mt-6 text-primary">
                <label class="flex items-center">
                  ...
                  <span class="ml-2">¿
                    ...
                    <router-link class="font-bold text-secondary" to="/terminos-y-condiciones">Términos y condiciones
                    </router-link>
                    y la
                    <router-link class="font-bold text-secondary" to="/politica-privacidad/">
