<template>
  <div class="min-h-screen bg-transparent">
    <div
      ...
      <img class="h-full w-full md:w-2/3 contain z-0" src="@/assets/img/asistSvg.svg" alt="" />
      <div class="mx-auto w-full max-w-sm flex-1 z-10 transform -translate-y-20 glass-light p-2 self-center">
        <div>
        ...
        <div class="mt-8">
          <div class="mt-6">
            <form @submit.prevent>
              <div>
                <label for="email" class="block text-sm font-medium leading-5 text-gray-900">
                  Email address
                </label>
              ...
              <div class="mt-6">
                <label for="password" class="block text-sm font-medium leading-5 text-gray-900">
                  Password
                </label>
                <div class="mt-1 rounded-md shadow-sm">
