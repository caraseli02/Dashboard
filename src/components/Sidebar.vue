    ...
    <aside v-if="userData"
      ...
      <div class="overflow-hidden shadow max-w-xs">
        ...
        <div class="text-center px-3 pb-6 pt-2">
          ...
          <h3 v-if="'surname' in userData" class="text-primary text-xl">
            {{ userData.surname }}
          </h3>
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0 mt-4">
        <label class="flex justify-start items-center uppercase tracking-wide text-secondary text-xs font-bold mb-2"
          for="grid-state">
          Horario de Trabajo
          <svg class="mx-2 text-blue-500" width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <div class="flex border-b-2 border-gray-500 items-center text-primary p-2">
          <div class="flex">
            <span v-if="'schedule' in userData" class="block font-bold text-primary mt-2 text-xl">{{
              userData["schedule"] }} horas</span>
            <span v-if="userData.eatHour" class="text-xs font-bold ml-8 flex flex-col justify-center items-center"><i
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0 mt-4">
        ...
        <div class="flex items-center p-2 border-b-2 border-gray-500">
          <div>
            ...
            <span v-if="'workplace' in userData" class="block text-xl font-bold text-primary">{{ userData["workplace"]
              }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="bottom-0 absolute w-full bg-secondary">
        <button @click="closeSession" class="flex items-center p-4 text-white w-full">
