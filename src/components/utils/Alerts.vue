<template>
  <transition name="fade">
    <div @click="clearNotification" v-if="showNotification"
      class="fixed top-0 mt-20 flex flex-col justify-around items-center h-64 w-full bg-gray-700 z-20"
    ...
    > -->
      <button class="my-3 mx-auto w-full">
        <span class="bg-gradient-to-r from-red-600 via-pink-500 to-red-700 hover:bg-green-400 text-white py-2 px-4 text-lg rounded
      ">Cerrar</span>
      </button>
    </div>
  </transition>
