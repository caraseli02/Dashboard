<template>
  <section class="fixed top-0 z-50 w-screen h-screen glass-dark rounded-none">
    <h1
      class="text-3xl mx-auto font-bold flex justify-center text-blue-600 animate-pulse w-full mt-10"
    >
      APIMOSA APP
    </h1>
    <div class="load">
      <div class="paint">
        ...
        <h2 class="text-2xl mx-auto">Preparando...</h2>
      </div>
      <div class="roller">
