  ...
  <header class="glass-light">
    <div class="mx-auto flex justify-center items-center">
      <nav class="flex items-center justify-between md:justify-between w-full">
        <section class="flex justify-start items-center p-3">
          <button
            v-if="!loadingMap"
        ...
        <button
          @click="signOut"
          class="ml-2 flex justify-center items-center p-3 rounded-lg glass-gray mr-2"
          v-if="user"
        >
          Salir
...
export default {
  components: { IconBase, IconMaps, IconArrowRight },
  computed: {
