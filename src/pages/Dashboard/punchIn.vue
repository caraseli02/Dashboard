<template>
  <ul v-if="checkCalendarToday === true || checkCalendarToday === selectedMes" :class="
      `w-screen flex flex-col justify-center items-center rounded-none`
    ">
    <!-- <li
    ...
    <li class="flex justify-center items-center mb-2">
      ...
      <select :value="value" id="vol" name="vol" required
        class="appearance-none block w-20 ml-2 my-2 px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus"
        @change="select">
