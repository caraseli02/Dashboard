        ...
        <div v-if="enterModal" class="flex justify-between flex-col items-center">
          <div class="flex justify-center items-center">
            <datetime :input-class="
              ...
              placeholder="Seleccionar la fecha" :max-datetime="d.toISOString()"></datetime>
            <span v-if="userData.enterTime" @click="userData.enterTime = null"
          ...
          <div class="flex justify-center items-center">
            <datetime type="datetime" value-zone="local" zone="local" :input-class="
                leaveTime
                  ? 'mb-4 mx-auto enterTime p-2 rounded-l-lg text-green-500 font-bold text-center text-lg shadow-xl'
                  : 'mb-4 mx-auto enterTime p-2 rounded-lg text-green-500 font-bold text-center text-lg  animate-bounce'
              " placeholder="Pulsa para seleccionar" v-model="leaveTime" :min-datetime="userData.enterTime"
              :max-datetime="setMaxDateTime"></datetime>
            <span v-if="leaveTime" @click="leaveTime = null"
              class="mb-4 text-center text-gray-900 bg-gradient-to-r from-red-400 via-pink-500 to-red-500 font-bold p-2 rounded-r-lg px-4 text-lg">
              X
            </span>
          </div>
  ...
  <section v-else class="flex flex-col justify-center items-center">
    ...
    <div v-else>
      ...
      <h1 class="text-red-600 text-2xl text-center m-4">
        ...
        <span class="text-gray-700 text-lg px-4 mt-2">Por favor habilita servicio de ubicación y recarga la
          pagina</span>
      </h1>
      <a class=" flex justify-center bg-gray-500 text-gray-700 text-lg rounded p-2 w-2/3 mt-8 mx-auto text-center"
        href="https://support.google.com/accounts/answer/3467281?hl=es-419">
        Como administrar tu ubicación
      </a>
      <span class="block mt-2 text-sm text-center">( Ayuda de Cuenta de Google )</span>
    </div>
  </section>
</template>
