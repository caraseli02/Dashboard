<template>
  <article class="max-h-screen flex flex-col justify-aroud items-center">
    ...
    <article class="flex flex-col justify-around items-center w-full">
      <section v-if="getUser" class="flex flex-col justify-between items-center py-8">
        <router-link v-for="(link, index) in buttons" :key="index" :to="link.path"
      ...
      <section v-else class="flex flex-col justify-between items-center py-8">
        <router-link v-for="link in links" :key="link.iconName" :to="link.path"
