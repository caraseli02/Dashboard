                        ...
                        <div class="w-full flex-shrink-0 lg:w-3/4 lg:flex-shrink rounded-xl">
                            <div class="flex space-x-4 lg:space-x-10">
                                <div
                                    ...
                                    <div class="bg-indigo-50 p-2 rounded-lg text-blue-800 w-full lg:w-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor" class="w-8 mx-auto">
                                    ...
                                    <div>
                                        <span
                                            class="block uppercase text-xs text-gray-400 tracking-wider font-semibold">Visitors</span>
                                        <span class="text-xl lg:text-2xl font-semibold">10,320</span>
                                    </div>
                                </div>
                                <div
                                    class="w-1/3 bg-white shadow-lg border border-gray-100 rounded-xl flex flex-col lg:flex-row items-center px-3 py-5 lg:p-5 space-x-0 lg:space-x-5">
                                    ...
                                    <div>
                                        <span
                                            class="block uppercase text-xs text-gray-400 tracking-wider font-semibold">Customers</span>
                                        <span class="text-xl lg:text-2xl font-semibold">4,628</span>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="bg-red-700 p-2 rounded-lg text-white w-full lg:w-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor" class="w-8 mx-auto">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div>
                                        <span
                                            class="block uppercase text-xs text-red-200 tracking-wider font-semibold">Orders</span>
                                        <span class="text-xl lg:text-2xl font-semibold text-white">2,980</span>
                                    </div>
                                </div>
                            </div>
